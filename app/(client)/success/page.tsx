      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-xl text-center">
        ...
        <div className="space-y-4 mb-8 text-left text-gray-600">
          <p>
            ...
            will ship it soon. A confirmation email with your order detals will
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link
            href={"/"}
            className="flex items-center justify-center px-4 py-3 font-semibold bg-green-500 text-white 
            rounded-lg hover:bg-green-600 shadow-md hoverEffect"
          >
